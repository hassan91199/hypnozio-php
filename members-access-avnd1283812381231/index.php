    ...
    <nav class="relative mt-8">
        <div x-data="{
            ...
            <div class="flex justify-between items-center">
                <img src="/assets/icons/logo.svg" class="w-[110px] md:w-[108px]" alt="nh">
                            ...
                            <div class="flex flex-wrap">
                                <div class="basis-full md:basis-8/12 lg:basis-1/2 mx-auto">
                                    <div class="">
                                        ...
                                        <h2 class="text-title-large lg:text-headline-large text-center">Gastric Band Hypnosis</h2>
