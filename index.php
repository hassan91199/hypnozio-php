                                                ...
                                                <div class="flex flex-col pl-4 -mr-1">
                                                    <a href="?l=de" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'de'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/german.svg" alt="Deutsch" />
                                                    ...
                                                    <a href="?l=en" class="no-underline text-onSurface p-4 rounded-l bg-primary text-white" x-bind:class="activeLanguageCode === 'en'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/united-kingdom.svg" alt="English" />
                                                    ...
                                                    <a href="?l=es" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'es'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/spain.svg" alt="Español" />
                                                    ...
                                                    <a href="?l=fr" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'fr'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/france.svg" alt="Française" />
                                                    ...
                                                    <a href="?l=it" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'it'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/italy.svg" alt="Italiano" />
                                                    ...
                                                    <a href="?l=nl" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'nl'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/nederlands.svg" alt="Nederlands" />
                                                    ...
                                                    <a href="?l=pl" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'pl'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/poland.svg" alt="Polski" />
                                                    ...
                                                    <a href="?l=ro" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'ro'
                                                        ...
                                                        <div class="flex items-center">
                                                            <img src="assets/romania.svg" alt="Românesc" />
            ...
            <div class="container">
                <div class="flex flex-wrap justify-between">
                    <div class="basis-full lg:basis-1/2 lg:pr-12">
                        ...
                        <img class="w-full rounded-tl-[64px] rounded-br-[64px] lg:hidden my-4" src="assets/female-with-headphones-mobile.png" alt="" />
                    ...
                    <div class="basis-full lg:basis-1/2 flex justify-end xl:justify-start">
                        <img class="hidden lg:block rounded-tl-[64px] rounded-br-[64px] lg:h-[450px] xl:h-[496px]" src="assets/female-with-headphones-desktop.png" alt="" />
                    </div>
                </div>
                <div class="mt-6 md:mt-10">
                    <div class="flex items-center">
                        ...
                        <img src="assets/stars-55.svg" alt="" />
                    </div>
                    <div class="flex mt-4">
                        <img class="w-[50px] h-[50px] rounded-full mr-4" src="assets/1.png" alt="" />
