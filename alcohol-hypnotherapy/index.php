...
$quizLink = '/alcohol-hypnotherapy/quiz.php' . '?' . $funnelParams;
                            ...
                            <div x-cloak x-show="navigationIsOpened" x-transition:enter="transition duration-300 transform ease-out" x-transition:enter-start="opacity-0 translate-x-full" x-transition:enter-end="opacity-100 translate-x-0" x-transition:leave="transition duration-300 transform ease-in" x-transition:leave-start="opacity-100 translate-x-0" x-transition:leave-end="opacity-0 translate-x-full" class="w-[279px] bg-white rounded-l-[64px] ml-auto mr-0 flex h-full flex-col">
                                <div class="px-4 py-2">
                                    ...
                                    <div class="mt-8 text-center">
                                        ...
                                        <div class="text-body-medium text-primary font-normal mt-2">support@hypnozio.com</div>
                                    </div>
                                    <div class="mt-8" x-cloak x-show="languageMobileNavIsOpened">
                                        <div class="flex lg:hidden flex-col space-y-2 justify-center items-center py-2 font-semibold text-onSurface">
                                            <div x-cloak x-show="languageMobileNavIsOpened" class="absolute top-0 bg-white h-screen w-[275px] rounded-l-[64px]" x-bind:class="languageMobileNavIsOpened ? 'fadeIn-center' : ''">
                                                ...
                                                <div class="mt-6 font-normal">
                                                    <div class="flex flex-col pl-4 -mr-1">
                                                        <!-- href="landing-alc-ffpc33ef.html?l=cs" -->
                                                        <a href="" class="no-underline text-onSurface p-4 rounded-l" x-bind:class="activeLanguageCode === 'cs'
                                                        ...
                                                        <!-- href="landing-alc-ffpc8c8a.html?l=de" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpcd8cc.html?l=en" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpcb8c2.html?l=es" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpc0ee9.html?l=fr" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpc1876.html?l=it" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpc175d.html?l=nl" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpc1d17.html?l=pl" -->
                                                        ...
                                                        <!-- href="landing-alc-ffpc0dcd.html?l=ro" -->
                                            ...
                                            <div class="text-body-medium text-secondary-blue font-normal">support@hypnozio.com</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div x-data="{ userGender: localStorage.getItem('userGender') }" x-init="$watch('userGender', val => localStorage.setItem('userGender', val))" class="mt-4 md:mt-8 pb-10 md:pb-20 lg:pb-8">
            <div class="container">
                <div class="flex flex-wrap justify-between">
                    <div class="basis-full lg:basis-5/12 lg:flex lg:flex-col lg:justify-center lg:pr-3">
                        <div class="text-headline-medium">
                            Find & fix root cause of <span class="text-accent font-bold">alcohol addiction</span> using self-hypnosis
                        </div>
                        ...
                        <div class="mt-4 md:mt-6">
                            ...
                            <div class="flex flex-wrap items-center mt-2 md:mt-6 justify-center lg:justify-center gap-4 lg:gap-6">
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn-accent" id="" @click="userGender = 'female'" href="<?= $femaleQuizLink ?>" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Female
                                </a>
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn" id="" @click="userGender = 'male'" href="<?= $maleQuizLink ?>" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Male
                                </a>
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn-outlined" id="" @click="userGender = 'other'" href="<?= $otherQuizLink ?>" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Other
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="mt-6 md:mt-10">
                            ...
                            <div class="flex mt-4">
                                ...
                                <div class="text-body-medium text-gray-80 font-normal">
                                    <div>What a discovery. I didn’t know I was even receptive to hypnotherapy! Helped me after couple of sessions.</div>
        ...
        <div class="container">
            <div class="lg:flex lg:justify-between lg:items-center">
                ...
                <div class="lg:flex space-y-6 lg:space-y-0 lg:space-x-10 mt-6 lg:mt-0">
                    ...
                    <a class="cursor-pointer link block text-center text-body-medium md:text-body-large text-footer-text hover:!text-footer-light no-underline" id="" target="" href="">
                        Privacy Policy
                    </a>
                    <a class="cursor-pointer link block text-center text-body-medium md:text-body-large text-footer-text hover:!text-footer-light no-underline" id="" target="" href="">
                        Terms &amp; conditions
