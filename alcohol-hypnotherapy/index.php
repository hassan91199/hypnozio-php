                    ...
                    <div class="basis-full lg:basis-5/12 lg:flex lg:flex-col lg:justify-center lg:pr-3">
                        ...
                        <div class="mt-4 md:mt-6">
                            ...
                            <div class="flex flex-wrap items-center mt-2 md:mt-6 justify-center lg:justify-center gap-4 lg:gap-6">
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn-accent" id="" @click="userGender = 'female'" href="test/hypnozio-quiz-alcohol-addiction/b2zz9kn.html?gender=female" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Female
                                </a>
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn" id="" @click="userGender = 'male'" href="test/hypnozio-quiz-alcohol-addiction/69rr26j.html?gender=male" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Male
                                </a>
                                <a class="cursor-pointer link w-[161px] sm:w-[267px] md:w-[275px] lg:w-[207px] xl:w-[217px] h-12 lg:h-16 cursor-pointer btn btn-outlined" id="" @click="userGender = 'other'" href="test/hypnozio-quiz-alcohol-addiction/5922jgb.html?gender=other" x-on:click="sendHypnozioQuizAnswerClickedEvent('Select your gender', userGender); sendHypnozioQuizStartedEvent()">
                                    Other
                                </a>
                            </div>
                        </div>
